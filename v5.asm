...
.data
 ...
 b db 1,0 ;неупакованное число 2
 c db 2,0 ;неупакованное число 12
 four db 4
 seven db 7
 two db 2
 ten db 10
 prod1 db 3 dup(0) ;4a = 16
 prod2 db 3 dup(0) ;2b = 2
 sub1 db 3 dup (0) ;4a-2b = 14
 prod3 db 3 dup(0) ;7c = 14
 sum1 db 3 dup(0)  ;4a-2b+c = 28
 rez db 2 dup (0)  ;частное (4a-2b+7c)/4 = 7 
.stack
 db 256 dup (0)
.code
main proc near
